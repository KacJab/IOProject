# Generated by Django 3.2.2 on 2022-01-04 14:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='images/default.png', null=True, upload_to='images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', models.CharField(choices=[('multiplayer', 'multiplayer'), ('easy', 'easy'), ('medium', 'medium'), ('hard', 'hard')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mode', models.CharField(choices=[('UNDEFINED', 'UNDEFINED'), ('EASY', 'EASY'), ('MEDIUM', 'MEDIUM'), ('HARD', 'HARD')], max_length=20, null=True)),
